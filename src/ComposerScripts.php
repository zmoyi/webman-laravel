...
{
    public static function manualLoadFile($filepath, $manualLoadFile, $action = 'install'): void
    {
        ...
        if ($action == 'install') {
            $manualLoadFile = './vendor/zmoyi/webman-laravel/' . $manualLoadFile;
        }
        ...
        $manualDumpScripts = [
            ...
            "Zmoyi\\WebmanLaravel\\ComposerScripts::postAutoloadDump",
        ];
